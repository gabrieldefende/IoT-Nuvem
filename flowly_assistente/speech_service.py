...
class SpeechService:
    ...
    def _listen_google(self) -> SpeechResult:
        try:
            ...
            # Python 3.13 removeu módulos (ex.: aifc) que versões atuais do SpeechRecognition ainda importam.
        ...
        try:
            ...
            # Dispositivo/driver de áudio
            pass
        except sr.WaitTimeoutError as e:
            raise RuntimeError("Tempo esgotado aguardando fala. Tente novamente.") from e

        # Caminho 2 (fallback): gravar com sounddevice e enviar ao recognizer
        try:
            import numpy as np
